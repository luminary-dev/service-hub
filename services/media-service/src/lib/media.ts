...
// "category" holds admin-uploaded trade cover images (#436). Prod stores it in
// R2 (no volume needed); local dev writes under $MEDIA_DIR/category.
const NAMESPACES = new Set(["provider", "review", "category"]);
