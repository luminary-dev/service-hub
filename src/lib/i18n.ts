...
const en = {
  ...
  assistant: {
    ...
    confirmTitle: "Review & send this inquiry",
    toLabel: "To",
  ...
  admin: {
    ...
    catCoverHint: "JPEG, PNG or WebP, up to 5MB — shown on provider cards for this trade.",
    catCoverUploading: "Uploading…",
    ...
    auditLogSubtitle:
      "Every moderation action taken by an admin, newest first. Filter by admin, action, or date range.",
    auditLogEmpty: "No matching audit log entries.",
    auditLogFilterAdmin: "Admin ID",
    auditLogFilterAction: "Action",
    auditLogFilterFrom: "From",
    auditLogFilterTo: "To",
    auditLogApply: "Apply filters",
    auditLogClear: "Clear filters",
    auditLogAdminLabel: "Admin",
    auditLogReasonLabel: "Reason",
    auditTargetProvider: "Provider",
    auditTargetPhoto: "Work photo",
    ...
    auditActions: {
      ...
      "reject-verification": "Rejected verification",
      suspend: "Suspended provider",
      unsuspend: "Unsuspended provider",
      "delete-photo": "Deleted photo",
      "restore-photo": "Restored photo",
      "delete-review": "Deleted review",
      "restore-review": "Restored review",
      "resolve-report": "Resolved report",
    ...
    adminFilterCityPh: "Filter by city…",
    adminFilterStatusAll: "All statuses",
    adminStatusVerified: "Verified",
    adminStatusPending: "Pending",
    adminStatusRejected: "Rejected",
    adminStatusNone: "Not submitted",
    adminFilterSuspendedAll: "All providers",
    adminFilterActiveOnly: "Active only",
    adminFilterSuspendedOnly: "Suspended only",
    adminSortLabel: "Sort by",
    adminSortNewest: "Newest",
    adminSortMostReviews: "Most reviews",
    adminClearFilters: "Clear filters",
    adminFound: (n: number) => `${n} provider${n === 1 ? "" : "s"} found`,
    adminNoResults: "No providers match these filters.",
    ...
    usersTitle: "Users",
    usersSubtitle: "Search customers and providers by name or email.",
    usersEmpty: "No users found.",
    usersSearchPlaceholder: "Search by name or email…",
    usersSearch: "Search",
    usersBack: "Back to users",
    usersJoined: "Joined",
    usersRole: "Role",
  ...
  toast: {
    ...
    adminRestored: "Restored successfully.",
    adminRestoreError: "Failed to restore.",
  ...
  welcome: {
    badge: "WELCOME",
    tag: "SETUP",
    title: "How will you use Baas.lk?",
    sub: "Pick one to get started — you can add the other later.",
    customerTitle: "I’m looking for services",
    customerBody: "Browse trusted local providers and send inquiries for free.",
    customerCta: "Continue as a customer",
    providerTitle: "I offer services",
    providerBody: "Create a provider profile so customers can find and contact you.",
    providerCta: "Set up my provider profile",
  },
  forgot: {
...
const si: Dict = {
  ...
  account: {
    ...
    photoHint: "JPEG, PNG හෝ WebP, 5MB දක්වා.",
    photoChange: "ඡායාරූපය උඩුගත කරන්න",
    photoUploading: "උඩුගත කරමින්…",
    photoRemove: "ඉවත් කරන්න",
    photoSaved: "පැතිකඩ ඡායාරූපය යාවත්කාලීන කරන ලදී.",
    nameLabel: "නම",
    phoneLabel: "දුරකථනය",
  ...
  assistant: {
    ...
    confirmTitle: "මෙම විමසීම පරීක්ෂා කර යවන්න",
    toLabel: "වෙත",
    messageLabel: "පණිවිඩය",
    contactLabel: "ඔබේ සම්බන්ධතා තොරතුරු",
    confirm: "තහවුරු කර යවන්න",
    cancel: "අවලංගු කරන්න",
  ...
  admin: {
    ...
    // Dashboard metrics (#219)
    statsTitle: "වේදිකා සංඛ්‍යාලේඛන",
    statsSubtitle: "පසුගිය දින 30.",
    statSignups: "නව ලියාපදිංචි (දින 30)",
    statPendingVerifications: "පොරොත්තු සත්‍යාපන",
    ...
    legendCustomers: "පාරිභෝගිකයන්",
    legendProviders: "වෘත්තිකයන්",
    chartNoData: "තවම ප්‍රමාණවත් දත්ත නැත.",
    ...
    catCover: "කවර පින්තූරය",
    catCoverHint: "JPEG, PNG හෝ WebP, 5MB දක්වා — මෙම ක්ෂේත්‍රයේ සැපයුම්කරු කාඩ්පත්වල පෙන්වයි.",
    catCoverUploading: "උඩුගත කරමින්…",
    ...
    auditLogTitle: "විගණන සටහන",
    auditLogSubtitle:
      "පරිපාලකයෙකු විසින් ගත් සෑම පාලන ක්‍රියාවක්ම, අලුත්ම මුලින්. පරිපාලක, ක්‍රියාව, හෝ දින පරාසය අනුව පෙරන්න.",
    auditLogEmpty: "ගැලපෙන විගණන සටහන් නැත.",
    auditLogFilterAdmin: "පරිපාලක හැඳුනුම්පත",
    auditLogFilterAction: "ක්‍රියාව",
    auditLogFilterFrom: "සිට",
    auditLogFilterTo: "දක්වා",
    auditLogApply: "පෙරහන් යොදන්න",
    auditLogClear: "පෙරහන් ඉවත් කරන්න",
    auditLogAdminLabel: "පරිපාලක",
    auditLogReasonLabel: "හේතුව",
    auditTargetProvider: "වෘත්තිකයා",
    auditTargetPhoto: "වැඩ ඡායාරූපය",
    ...
    auditActions: {
      ...
      "reject-verification": "සත්‍යාපනය ප්‍රතික්ෂේප කළා",
      suspend: "වෘත්තිකයා අත්හිටුවනු ලැබුවා",
      unsuspend: "වෘත්තිකයා නැවත සක්‍රිය කළා",
      "delete-photo": "ඡායාරූපය මකා දැමුවා",
      "restore-photo": "ඡායාරූපය ප්‍රතිසාධනය කළා",
      "delete-review": "සමාලෝචනය මකා දැමුවා",
      "restore-review": "සමාලෝචනය ප්‍රතිසාධනය කළා",
      "resolve-report": "වාර්තාව විසඳුවා",
    ...
    adminFilterCityPh: "නගරය අනුව පෙරහන්...",
    adminFilterStatusAll: "සියලු තත්ත්ව",
    adminStatusVerified: "සත්‍යාපිත",
    adminStatusPending: "පොරොත්තුවෙන්",
    adminStatusRejected: "ප්‍රතික්ෂේප කළ",
    adminStatusNone: "යොමු කර නැත",
    adminFilterSuspendedAll: "සියලු වෘත්තිකයන්",
    adminFilterActiveOnly: "සක්‍රිය පමණි",
    adminFilterSuspendedOnly: "අත්හිටුවූ පමණි",
    adminSortLabel: "අනුපිළිවෙල",
    adminSortNewest: "අලුත්ම",
    adminSortMostReviews: "වැඩිම සමාලෝචන",
    adminClearFilters: "පෙරහන් ඉවත් කරන්න",
    adminFound: (n: number) => `වෘත්තිකයන් ${n}ක් හමු විය`,
    adminNoResults: "මෙම පෙරහන්වලට ගැලපෙන වෘත්තිකයන් නැත.",
    // Automated flagging (#232)
    ...
    usersSubtitle: "නම හෝ විද්‍යුත් තැපෑල අනුව පාරිභෝගිකයන් සහ වෘත්තිකයන් සොයන්න.",
    usersEmpty: "පරිශීලකයන් හමු නොවීය.",
    usersSearchPlaceholder: "නම හෝ විද්‍යුත් තැපෑල අනුව සොයන්න…",
    usersSearch: "සොයන්න",
    usersBack: "පරිශීලකයන් වෙත ආපසු",
    usersJoined: "එකතු වූ දිනය",
    usersRole: "භූමිකාව",
  ...
  toast: {
    ...
    adminRestored: "සාර්ථකව ප්‍රතිස්ථාපනය කරන ලදී.",
    adminRestoreError: "ප්‍රතිස්ථාපනය කිරීමට අසමත් විය.",
  ...
  welcome: {
    ...
    tag: "සැකසුම",
    title: "ඔබ Baas.lk භාවිතා කරන්නේ කෙසේද?",
    sub: "ආරම්භ කිරීමට එකක් තෝරන්න — අනෙක පසුව එක් කළ හැක.",
    customerTitle: "මම සේවා සොයමි",
    customerBody: "විශ්වාසනීය දේශීය සැපයුම්කරුවන් පිරික්සා නොමිලේ විමසීම් යවන්න.",
    customerCta: "පාරිභෝගිකයෙකු ලෙස ඉදිරියට",
    providerTitle: "මම සේවා සපයමි",
    providerBody: "පාරිභෝගිකයින්ට ඔබව සොයා ගැනීමට සැපයුම්කරු පැතිකඩක් සාදන්න.",
    providerCta: "මගේ සැපයුම්කරු පැතිකඩ සකසන්න",
  },
  forgot: {
