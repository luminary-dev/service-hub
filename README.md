...
Microservices behind an API gateway; the Next.js app is a pure frontend. Full details in [docs/ARCHITECTURE.md](docs/ARCHITECTURE.md). Team documentation (onboarding, workflow, operations) lives in [luminary-dev/docs](https://github.com/luminary-dev/docs).
