...
- [Architecture overview](ARCHITECTURE.md)
  ...
  - [Environment variables](architecture/environment.md)
  - [Data ownership](architecture/data-model.md)
  - [Uploads](architecture/uploads.md)
  - [API gateway & routing](architecture/gateway.md)
  - [Admin surface](architecture/admin-surface.md)
  - [Web app & local development](architecture/web-and-dev.md)
- [API reference](API.md)
  - [Request lifecycle & conventions](api/request-lifecycle.md)
  - [Public / client API](api/public.md)
...
- [Features](FEATURES.md)
  - [Registration, profile & verification](features/registration.md)
  - [Discovery](features/discovery.md)
  - [Inquiries & messaging](features/inquiries.md)
...
- [Admin guide](ADMIN.md)
  - [Accessing the panel & dashboard](admin/access-and-dashboard.md)
