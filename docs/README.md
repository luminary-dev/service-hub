...
| [DEPENDENCIES.md](DEPENDENCIES.md) | Forward-looking dependency decisions: the `@hono/node-server` 1.x → 2.x migration plan and the Node 24 LTS runtime alignment (#666), plus known-behind dev tooling. |
